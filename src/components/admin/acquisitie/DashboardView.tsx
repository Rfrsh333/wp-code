            ...
            {todoLeads.map((lead) => (
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  lead.auto_sequence_next_action?.includes("LinkedIn") ? "bg-cyan-100 text-cyan-700" :
                  lead.auto_sequence_next_action?.includes("Instagram") ? "bg-pink-100 text-pink-700" :
                  lead.auto_sequence_next_action?.includes("Meeting") ? "bg-emerald-100 text-emerald-700" :
                  ...
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    ) : lead.auto_sequence_next_action?.includes("Meeting") ? (
