    ...
    >
      ...
      <div className="mx-3 mb-3 rounded-2xl bg-white/95 backdrop-blur-xl shadow-2xl border border-neutral-200/50">
        <div className="grid grid-cols-3 gap-2 p-2">
          ...
          >
            <svg
              className="w-6 h-6 text-green-600 group-hover:scale-110 transition-transform duration-200"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              className="w-6 h-6 text-blue-600 group-hover:scale-110 transition-transform duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <span className="text-xs font-medium text-neutral-700">Bel direct</span>
          </a>

          {/* Personeel aanvragen Button - Primary CTA (Dominant) */}
          <Link
