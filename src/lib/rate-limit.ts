...
// On Vercel the platform appends the real client IP as the LAST element of
// x-forwarded-for, so we read from the right to prevent spoofing via a
// client-controlled leftmost hop.
