        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn direction="right" delay={0.2}>
              <div className="bg-gradient-to-br from-[#F27501]/10 to-orange-100/50 rounded-3xl p-12 flex items-center justify-center aspect-square lg:aspect-auto lg:h-[450px]">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8" staggerDelay={0.1}>
            {[
              ...
              <StaggerItem key={i}>
                <div className="bg-neutral-50 rounded-2xl p-8 border border-neutral-100 hover:border-[#F27501]/20 hover:shadow-lg transition-all duration-300 h-full">
            ...
            {[
              ...
              <StaggerItem key={i}>
                <div className="text-center p-8 bg-neutral-800/50 rounded-2xl border border-neutral-700/50">
                  <div className="text-5xl md:text-6xl font-bold text-[#F27501] mb-4">{stat.value}</div>
