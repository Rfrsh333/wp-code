...
export default function UitzendenRotterdamPage() {
  return (
    <>
      {/* HERO */}
            ...
            <FadeIn direction="left">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-[1.1]">
                  Horeca uitzenden Rotterdam
                </h1>
                <p className="text-xl text-neutral-600 mb-8 leading-relaxed max-w-xl">
                  Snel personeel nodig in het havengebied, voor grote events of zakelijke horeca?
                  Wij leveren binnen 24 uur inzetbare horecakrachten in Rotterdam
                  met heldere afspraken en lokale beschikbaarheid.
                </p>
            ...
            <FadeIn direction="right" delay={0.2}>
              <div className="hidden lg:flex justify-center lg:justify-end">
                <PremiumImage
                  ...
                  alt="Tijdelijk horecapersoneel in Rotterdam tijdens een dienst"
                  width={480}
                  height={480}
                />
              </div>
          ...
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">
                Tijdelijk horecapersoneel in Rotterdam
              </h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                Voor piekdrukte, evenementen of uitval leveren wij tijdelijk horecapersoneel
                in Rotterdam. De inzet is flexibel en afgestemd op uw planning.
              </p>
            </div>
          </FadeIn>
        </Section.Container>
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                ...
                dat past bij hoge piekdrukte en zakelijke horeca-omgevingen.
              </p>
            </div>
          </FadeIn>
        </Section.Container>
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                ...
                aan grote events en hoge piekdrukte. Bekijk{" "}
      ...
      <RelatedLocations currentCity="rotterdam" service="uitzenden" />
      <FaqJsonLd city="Rotterdam" service="uitzenden" />
    </>
  );
}
