...
export default function DetacheringRotterdamPage() {
  return (
    <>
      {/* HERO */}
            ...
            <FadeIn direction="left">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-[1.1]">
                  Detachering horeca personeel Rotterdam
                </h1>
                <p className="text-xl text-neutral-600 mb-8 leading-relaxed max-w-xl">
                  Voor zakelijke horeca, havenlocaties en grote events is continuiteit cruciaal.
                  Wij leveren vaste krachten in Rotterdam met duidelijke afspraken en begeleiding.
                </p>
            ...
            <FadeIn direction="right" delay={0.2}>
              <div className="hidden lg:flex justify-center lg:justify-end">
                <PremiumImage
                  ...
                  alt="Gedetacheerde horecakracht in Rotterdam tijdens een dienst"
                  width={480}
                  height={480}
                />
              </div>
      ...
      <Section variant="white" spacing="default">
        <Section.Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              "U houdt stabiliteit in de bezetting en werkt met vaste medewerkers.",
      ...
      {/* WAAROM TOPTALENT ROTTERDAM */}
      <Section variant="white" spacing="default">
        <Section.Container>
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">
                Waarom TopTalent in Rotterdam
              </h2>
              <div className="bg-white rounded-2xl p-8 md:p-10 border border-neutral-100 shadow-sm max-w-3xl mx-auto">
                <p className="text-lg text-neutral-600">
                  ...
                  aan hoge piekdrukte en zakelijke horeca. Bekijk{" "}
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center text-sm font-medium">
                  <Link href="/locaties/rotterdam" className="text-[#F97316] hover:underline">
                    Terug naar locatie Rotterdam
                  </Link>
            ...
            <div className="mt-6 bg-gradient-to-br from-[#F97316] to-[#EA580C] rounded-3xl p-12 lg:p-16 text-center text-white relative overflow-hidden shadow-xl shadow-orange-500/20">
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Direct personeel nodig in Rotterdam?
                </h2>
                <p className="text-white/90 text-lg leading-relaxed mb-10">
                  Geef uw planning door en wij regelen de inzet in Rotterdam.
                </p>
      ...
      <RelatedLocations currentCity="rotterdam" service="detachering" />
      <FaqJsonLd city="Rotterdam" service="detachering" />
    </>
  );
}
