            ...
            <FadeIn direction="left">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-[1.1]">
                  Detachering horeca personeel Amsterdam
                </h1>
                <p className="text-xl text-neutral-600 mb-8 leading-relaxed max-w-xl">
                  Voor hotels, internationale locaties en grote evenementen is stabiliteit essentieel.
                  Wij leveren vaste krachten in Amsterdam met snelle onboarding en heldere afspraken.
                </p>
            ...
            <FadeIn direction="right" delay={0.2}>
              <div className="hidden lg:flex justify-center lg:justify-end">
                <PremiumImage
                  ...
                  alt="Gedetacheerde horecakracht in Amsterdam tijdens een dienst"
                  width={480}
                  height={480}
                />
              </div>
