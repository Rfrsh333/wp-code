          ...
          <div className="mt-16 pt-12 border-t border-neutral-200/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center group">
                ...
                <p className="text-sm text-neutral-500">Een vast aanspreekpunt voor jou</p>
              </div>
              ...
              <div className="text-center group">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1">Mooie werkgevers</h3>
                <p className="text-sm text-neutral-500">Werk bij horecazaken in jouw regio</p>
              </div>
            </div>
          </div>
        </Section.Container>
