...
export default function MedewerkerWachtwoordVergetenPage() {
    ...
    <div className="min-h-screen bg-neutral-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-500 mt-2">Vraag een resetlink aan voor uw medewerkeraccount</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/medewerker/login" className="text-sm text-neutral-500 hover:text-[#F27501]">
