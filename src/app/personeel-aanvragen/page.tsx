  ...
  return (
    <>
      {/* ============================================================
          ...
          Hero (white) → Form (tinted)
          ============================================================ */}

      {/* Hero + Form Section - Tinted */}
        ...
        <Section.Container>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 mb-6">
              Vind passend{" "}
              <span className="text-[#F97316]">horecapersoneel</span>
            </h1>
            <p className="text-neutral-600 text-lg">
              Vul het formulier in en wij nemen zo snel mogelijk contact met u op, vaak binnen 24 uur.
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1">Vertrouwd door horecaondernemers</h3>
